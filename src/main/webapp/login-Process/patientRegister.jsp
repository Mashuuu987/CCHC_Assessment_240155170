    ...
    <body>
        ...
        <div class="register-wrapper">
            <div class="register-card">
                ...
                <form method="post" action="PatientRegisterController">
                    ...
                    <div class="field-group">
                        ...
                        <input class="field-input" type="text" id="hkid" name="hkid" required>
                    </div>

                    <div class="field-group">
                        <label class="field-label" for="firstName">First name</label>
                        <input class="field-input" type="text" id="firstName" name="firstName" required>
                    </div>

                    <div class="field-group">
                        <label class="field-label" for="lastName">Last name</label>
                        <input class="field-input" type="text" id="lastName" name="lastName" required>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <input class="field-input" type="date" id="dob" name="dob" required>
                    </div>

                    <div class="field-group">
                        <label class="field-label" for="phone">Phone</label>
                        <input class="field-input" type="text" id="phone" name="phone" required>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <textarea class="field-input" id="address" name="address" rows="2"></textarea>
                    </div>

                    <div class="field-group">
                        <label class="field-label" for="emergencyContactFullName">Emergency contact full name (optional)</label>
                        <input class="field-input" type="text" id="emergencyContactFullName" name="emergencyContactFullName">
                    </div>

                    <div class="field-group">
                        <label class="field-label" for="emergencyContact">Emergency contact phone (optional)</label>
                        <input class="field-input" type="text" id="emergencyContact" name="emergencyContact">
                    </div>
