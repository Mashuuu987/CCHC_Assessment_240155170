 ...
 * @author amzte
 */
@WebServlet(name = "AppointmentRecordStaffAdminActionController", urlPatterns = {"/AppointmentRecordStaffAdminAction"})
public class AppointmentRecordStaffAdminActionController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isStaff) {
            ...
            if (staff == null || staff.getClinicId() == null) {
                response.sendRedirect(request.getContextPath() + "/AppointmentRecordsStaffAdmin");
                return;
            }
        }
